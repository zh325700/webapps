...
$route['default_controller'] = 'Residents_control/index';
$route['(:any)'] = 'Residents_control/index';/* $route['(:any)'] = 'pages/view/$1'; means that anything you type on the url will proceed
