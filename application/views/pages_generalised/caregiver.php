		...
		?>
                ...
                <div class ="row">
                    <div class="col-sm-offset-0">
                        <img id="home" class="topIcon" src="<?php echo base_url(); ?>/image/pictograms/home.png"  alt="HOME" Onclick="location.href = '<?php echo base_url(); ?>index.php/Welcome/Overview/newOverView'"/>
