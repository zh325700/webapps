                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-2 col-sm-2" style="margin-top: 3%">
                            <img src="../../image/photos/<?= $pic?>" alt="" style=" width: 150px" class="align-left"/>
                        </div>
                    ...
                    <div class="row" style="height: 10%">
                        <div class="col-md-offset-3 col-md-2 col-sm-offset-3 col-sm-3" >
                            <input type="button" class="btn btn-lg button style btn-block" style="height: 100%; border-radius: 10px;"
