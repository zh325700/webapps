<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-4">
                    <img src="<?php echo base_url(); ?>/image/myPicture.png" alt="" style=" width: 120px" class="align-left"/>
		</div>
		<div class="col-md-4">
	...
	<div class="row">
		<div class="col-md-4">
                    <button id = "newButton"  type="button" class="btn btn-lg active style" >
                        Family <br/>
                        <img src="<?php echo base_url(); ?>/image/family.png" style="width: 180px; padding-right: 35px" class=""/>
                    </button>  
		</div>
		<div class="col-md-4">
                    <button id = "newButton" type="button" class="btn btn-lg question active" onclick="loadPage('Resident/categories')">
                        Questionnaire <br/>
                        <img src="<?php echo base_url(); ?>/image/questions.png" style="width: 200px" class=""/>
                    </button>  
		</div>
		<div class="col-md-4">
                    <button id = "newButton" type="button" class="btn btn-lg style active" style="padding-right: 40px; padding-bottom: 25px; right: -30px">
                        Activities <br/>
                        <img src="<?php echo base_url(); ?>/image/activities.png" style="width: 180px; padding-right: 35px" class=""/>
                    </button>  
		</div>
	</div>
	<div class="row">
