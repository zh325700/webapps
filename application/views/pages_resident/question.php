<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-4">
			<img src="<?php echo base_url(); ?>/image/food.png" alt="" style=" width: 150px" class="align-left"/>
		</div>
		<div class="col-md-4">
	...
	<div class="row">
		<div class="col-md-12">
			<img src="<?php echo base_url(); ?>/image/Smileys.png" alt="" style="width:850px" class="center" usemap="#map"/>
			<map name="map">
