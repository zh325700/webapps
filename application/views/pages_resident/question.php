...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12">
			<img src="<?php echo base_url(); ?>/image/pictograms/Smileys.png" alt="" class="smiley center-block" usemap="#map"/>
			<map name="map">
	...
	<div class="row">
		<div class="col-md-4">			 
			<button id = "prevButton" type="button" class="btn btn-lg style active previous" onclick="javascript:previous()">
