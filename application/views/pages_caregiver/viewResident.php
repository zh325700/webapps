...
<div class="container-fluid flex">
	...
	<div id="forms" class="col-md-offset-0 col-sm-offset-0 col-sm-4">
       ...
       <!-- <div id="forms" class="col-md-offset-0 col-sm-offset-1 col-sm-1" style="padding-left:0%">
            <label>{LastName}:</label><br>
            <label>{FirstName}:</label><br>
            <label>{Gender}:</label><br>
            <label>{Birthday}:</label>
        </div>
	<div id="forms" class=" col-md-offset-0 col-sm-offset-0 col-sm-1" style="padding-left:5%" data-step="2" data-intro="Here you can find Information of residents" data-position='right'>
            <label class="lab pad2"> <?php echo $residents['LastName']; ?></label><br>
            <label class="lab pad2"> <?php echo $residents['FirstName']; ?></label><br>
            <label class="lab pad2"> <?php echo $residents['Sex']; ?></label><br>
            <label class="lab pad2"> <?php echo $residents['Birthday']; ?></label>
	</div>
        
        <div id="forms" class="col-md-offset-1 col-sm-offset-1 col-sm-1" style="padding-left:2.5%">
            <label>{RoomNumber}:</label><br>
            <label>{Facility}:</label><br>
            <label>{MemberSince}:</label>
        </div>
        <div id="forms" class="col-md-offset-1 col-sm-offset-1 col-sm-2" style="padding-left:0%;" >
            <label class="lab pad" > <?php echo $residents['RoomNumber']; ?></label><br>
            <label class="lab pad" > <?php echo $fac_name['Name']; ?></label><br>
            <label class="lab pad" > <?php echo $residents['Member_Since']; ?></label>
	</div>-->
    </div>
    <div class="row" style="padding-bottom: 4%; padding-top: 2%">
        ...
        <div class="col-sm-offset-0 col-md-offset-1 col-sm-4 col-md-3" style="padding-left:2.5%; padding-right:5%">
