...
$query_DataBase = (" 	CREATE DATABASE IF NOT EXISTS $dbname;
						");
$query_DropTables = (" 	DROP TABLE IF EXISTS Answers;
...
$query_Questions = ("	CREATE TABLE Questions(	ID_Question INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
						...
						INSERT INTO Questions(Type_en, Question_en, Type_nl, Question_nl) VALUES('StaffResponsiveness'	, 'My services are delivered when I want them.'										, 'ReagerenDoorMedewerkresOpVragen'		, 'Medewerkers helpen me wanneer ik wil.');
						...
						INSERT INTO Questions(Type_en, Question_en, Type_nl, Question_nl) VALUES('StaffResidentBonding'	, 'I have a special relationship with a staff member.'								, 'EenBandVoelenMetWieHierWerkt'		, 'Ik heb een speciale relatie met een medewerker.');
						...
						INSERT INTO Questions(Type_en, Question_en, Type_nl, Question_nl) VALUES('Activities'			, 'I have enjoyable things to do here in the evenings.'								, 'Activiteiten'						, 'Ik kan hier savonds aan leuke dingen deelnemen.');
